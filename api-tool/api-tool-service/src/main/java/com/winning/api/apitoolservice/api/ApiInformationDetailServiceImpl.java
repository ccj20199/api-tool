...
import com.winning.api.apitoolentity.*;
...
import com.winning.api.apitoolservice.util.ApiParamInfoUtil;
...
public class ApiInformationDetailServiceImpl {
    ...
    private void checkData(com.winning.api.apitoolservice.vo.apiinfo.save.SaveApiInfoInputVO inputVO, List<ApiInformationDetailUpdatePO> apiInformationDetailUpdatePOS) {
    ...
    private void saveData(SaveApiInfoInputVO inputVO,
        ...
        for (ApiInformationDetailUpdatePO updatePO : apiInformationDetailUpdatePOS) {
            if (Objects.isNull(updatePO.getApiId())){
                ...
                detailPO.setCheckOutBy(inputVO.getSubmitBy());
                apiInformationDetailRepository.save(detailPO);
                apiParameterInformationRepository.deleteByApiId(updatePO.getApiId());
