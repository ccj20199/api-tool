package com.winning.api.apitoolservice.vo.apiinfo.search;
...
public class ApiInfoByIdOutVO {
    ...
    private List<com.winning.api.apitoolservice.vo.apiinfo.search.ApiParameter> inputParameterList;

    @ApiModelProperty(value = "API的出参列表",position = 120)
    private List<com.winning.api.apitoolservice.vo.apiinfo.search.ApiParameter> OutputParameterList;
}
